  ...
  return (
    <div className="py-32 grid grid-cols-1 xl:grid-cols-3 items-center container mx-auto gap-10 xl:gap-0">
      <div className="flex w-full flex-col mx-auto max-w-sm text-white bg-gray-800 p-6 xl:py-9 xl:px-12 transition-all duration-500 hover:bg-gray-900 ">
        <h3 className="font-manrope text-2xl font-bold mb-3">Beginner</h3>
        <div className="flex items-center mb-6">
          <span className="font-manrope mr-2 text-5xl font-semibold whitespace-nowrap">2,190 THB</span>
        </div>
      ...
      <div className="flex w-full flex-col mx-auto max-w-sm text-white bg-gray-800 transition-all duration-500 hover:bg-gray-900">
        <div className="uppercase bg-gradient-to-r from-blue-400 to-blue-600 p-3 text-center text-white">
          MOST POPULAR
        </div>
        <div className="p-6 xl:py-9 xl:px-12 flex flex-col">
          <h3 className="font-manrope text-2xl font-bold mb-3">Intermediate</h3>
          <div className="flex items-center mb-6">
            <span className="font-manrope mr-2 text-5xl font-semibold text-blue-600  whitespace-nowrap">
              6,490 THB
            </span>
          </div>
      ...
      <div className="flex w-full flex-col mx-auto max-w-sm text-white bg-gray-800 p-6 xl:py-9 xl:px-12 transition-all duration-500 hover:bg-gray-900">
        ...
        <div className="flex items-center mb-6">
          <span className="font-manrope mr-2 text-5xl font-semibold whitespace-nowrap">10,900 THB</span>
        </div>
        <ul className="mb-12 space-y-6 text-left text-lg text-white">
          {[
            "Free 5 EA Key",
